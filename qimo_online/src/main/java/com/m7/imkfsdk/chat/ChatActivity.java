 ...
 * @author LongWei
 */
public class ChatActivity extends MyBaseActivity implements OnClickListener, OnItemClickListener,
        ChatListView.OnRefreshListener, AudioRecorderButton.RecorderFinishListener {

    private ChatListView mChatList;
    private Button mChatSend, mChatMore, mChatSetModeVoice, mChatSetModeKeyboard, chat_btn_convert;
    ImageView chat_btn_back;
    private EditText mChatInput;
    private ChatAdapter chatAdapter;
    private RelativeLayout mChatEdittextLayout, mChatMoreContainer;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == HANDLER_BREAK) {
                ...
                QMCustomerServiceManager.mIsInitQMSDK = false;
                finish();
            }
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    if (ContextCompat.checkSelfPermission(ChatActivity.this,
                        ...
                        ActivityCompat.requestPermissions(ChatActivity.this,
                                new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0x2222);
                    }
                }
    ...
    private void showSessionFinishDialog() {
        new AlertDialog.Builder(this).setTitle("温馨提示").setMessage("客服结束了会话，你想要")
    ...
    private void showVipAssignFailDialog() {
        new AlertDialog.Builder(this).setTitle("温馨提示").setMessage("你的专属座席不在线，是否需要其它座席服务")
                .setPositiveButton("需要", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

                        IMChatManager.getInstance()
                                .acceptOtherAgent(peerId, new AcceptOtherAgentListener() {
                                    @Override
                                    public void onSuccess() {
                                        Toast.makeText(ChatActivity.this, "已通知其它座席为你服务",
                                                Toast.LENGTH_SHORT).show();
                                    }

                                    @Override
                                    public void onFailed() {
                                        Toast.makeText(ChatActivity.this, "通知其它座席失败",
                                                Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT > 22) {
            ...
            if (ContextCompat.checkSelfPermission(ChatActivity.this,
                ...
                //申请该权限
                ActivityCompat.requestPermissions(ChatActivity.this,
                        new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0x1111);
            }
        } else {
            beginSession(peerId);
        }
    ...
    public void JZMoreMessage() {
        ...
        // 是否有数据
        if (IMChatManager.getInstance().isReachEndMessage(descFromToMessage.size())) {
            mChatList.setSelectionFromTop(fromToMessage.size() - (i - 1) * 15, height);
            mChatList.dismiss();
        } else {
            mChatList.setSelectionFromTop(fromToMessage.size() - (i - 1) * 15 + 1, height);
        }
    ...
    public void init() {
        ...
        mChatEmojiChecked = (ImageView) this.findViewById(R.id.chat_emoji_checked);
        mChatFaceContainer = (RelativeLayout) this.findViewById(R.id.chat_face_container);
        mChatMoreContainer = (RelativeLayout) this.findViewById(R.id.chat_more_container);
        ...
        mTvUnRegister = (TextView) this.findViewById(R.id.chat_tv_back);
        ...
        //				"拍照");
        ChatMore chatMore2 = new ChatMore(2, R.drawable.kf_icon_chat_pic + "", "图库");
        ChatMore chatMore3 = new ChatMore(3, R.drawable.kf_icon_chat_file + "", "文件");
        ChatMore chatMore4 = new ChatMore(4, R.drawable.kf_icon_chat_investigate + "", "评价");
    ...
    public void onClick(View v) {
        ...
        int i1 = v.getId();
        if (i1 == R.id.chat_btn_back) {
            finish();

        } else if(i1 == R.id.chat_tv_back){
            IMChatManager.getInstance().quit();
            QMCustomerServiceManager.mIsInitQMSDK = false;
            finish();
        }else if (i1 == R.id.chat_btn_convert) {//转人工服务
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                if (ContextCompat
                    ...
                    //申请该权限
                    ActivityCompat.requestPermissions(ChatActivity.this,
                            new String[]{Manifest.permission.RECORD_AUDIO}, 0x4444);
                }
            }
    ...
    private void initMoreViewPager() {
        ...
        for (int i = 0; i < moreLists.size(); i++) {
            ...
            MoreAdapter adapter = new MoreAdapter(this, moreLists.get(i), handler);
            ...
            public void onPageSelected(int arg0) {
                ...
                if (arg0 == pointViewsMore.size() - 1 || arg0 == 0) {
                    if (arg0 == 0) {
                        ...
                        // 会再次实现该回调方法实现跳转.
                        pointViewsMore.get(1).setBackgroundResource(R.drawable.kf_d2);
                    } else {
                        mChatMoreVPager.setCurrentItem(arg0 - 1);// 倒数第二屏
                        pointViewsMore.get(arg0 - 1).setBackgroundResource(R.drawable.kf_d2);
                    }
                }
            }
            ...
            public void onPageSelected(int arg0) {
                ...
                if (arg0 == pointViewsFace.size() - 1 || arg0 == 0) {
                    if (arg0 == 0) {
                        ...
                        // 会再次实现该回调方法实现跳转.
                        pointViewsFace.get(1).setBackgroundResource(R.drawable.kf_d2);
                    } else {
                        mChatEmojiVPager.setCurrentItem(arg0 - 1);// 倒数第二屏
                        pointViewsFace.get(arg0 - 1).setBackgroundResource(R.drawable.kf_d2);
                    }
                }
            }
        ...
        if (mChatFaceContainer.getVisibility() == View.VISIBLE &&
            ...
            if (!TextUtils.isEmpty(emoji.getCharacter())) {
                ...
                SpannableString spannableString = FaceConversionUtil.getInstace()
                        .addFace(this, emoji.getId(), emoji.getCharacter(), mChatInput);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
        ...
        } else if (requestCode == PICK_FILE_ACTIVITY_REQUEST_CODE &&
            ...
            if (file.exists()) {
                ...
                if ((fileSize / 1024 / 1024) > 20.0) {
                    ...
                    //发送文件
                    FromToMessage fromToMessage = IMMessage
                            .createFileMessage(path, fileName, fileSizeStr);
                    ArrayList fromTomsgs = new ArrayList<FromToMessage>();
                    fromTomsgs.add(fromToMessage);
                    descFromToMessage.addAll(fromTomsgs);
                    chatAdapter.notifyDataSetChanged();
    ...
    private void sendInvestigate() {
        ArrayList<Investigate> investigates = (ArrayList<Investigate>) IMChatManager.getInstance()
                .getInvestigate();
